...
\item Some curtains continuously precipitate into the atmosphere for multiple seconds, \add{a lower bound duration that is set by AC6's in-track lag.}
\end{enumerate}
