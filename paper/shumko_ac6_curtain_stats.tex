...
Curtains are stationary electron precipitation phenomena observed in low Earth orbit (LEO). They are narrow in latitude and appear stationary for up to a minute between subsequent satellite passes. \citeA{Blake2016} recently discovered curtains with the $> 30$ keV electron dosimeters onboard the dual AeroCube-6 (AC6) CubeSats that operated together between 2014 and 2017 and actively maintained their in-track separation between a few hundred meters and a few hundred kilometers. Besides the \citeA{Blake2016} discovery study not much is known about curtains. We do not know what curtains are, their origin, statistical properties, and their impact on the atmosphere. Answering these questions is an essential next step towards a more complete understanding of how curtains affect the  magnetosphere and Earth.

Multi-spacecraft missions, such as AC6, are necessary to distinguish curtains from similar-looking transient precipitation called microbursts. Microbursts are a spiky increase of electrons shorter than a second and have been observed since mid 1960s by high altitude balloons and satellites \cite<e.g.>{Anderson1964, Lorentzen2001a, O'Brien2003, Douma2017}

Because curtains look like microbursts until you use two spacecraft hence \citeA{Blake2016} proposed a hypothesis that curtains are remnants of microbursts drifting around the Earth. \textcolor{red}{Microbursts are a form of electron precipitation...} If curtains are microburst remnants than we will have to reevaluate prior statistical studies of microbursts and 
