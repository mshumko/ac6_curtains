...
\begin{abstract}
Electron curtains are recently discovered stationary, persistent, and narrow in latitude precipitation phenomena observed in low Earth orbit by sequential passes of the dual AeroCube-6 CubeSats. The $> 30 $ keV curtains were observed over a variety of spacecraft separations, up to 65 seconds or 500 kilometers in-track. This study expands on the initial curtain discovery and quantifies the statistical properties of 1600 curtains observed over three years. We test the hypothesis that curtains are drifting remnants of microbursts and compare the curtain and microburst properties throughout this study. We found that in low Earth orbit, many curtains are narrower than 10 kilometers in latitude and 90\% are less than 21 kilometers wide. We also found that curtains are an outer radiation belt phenomena that are observed in the late morning and midnight magnetic local time, with a higher occurrence rate at midnight. Furthermore curtains are observed more often at lower geomagnetic activity than microbursts. Lastly, we found a few curtains in the bounce loss cone region in the north Atlantic Ocean where drift mission is impossible. In one example, a curtain was continuously scattered for at least six seconds so curtains can be a significant source of $> 30$ keV electrons into the atmosphere.
\end{abstract}
...
Curtains are stationary electron precipitation phenomena observed in low Earth orbit (LEO). They are narrow in latitude, spiky, and appear stationary for up to a minute between subsequent satellite passes. \citeA{Blake2016} recently discovered curtains with the $> 30$ keV electron dosimeters onboard the dual AeroCube-6 (AC6) CubeSats that operated together between 2014 and 2017 and actively maintained their in-track separation between a few hundred meters and a few hundred kilometers. Besides the \citeA{Blake2016} discovery study not much is known about curtains. We do not know what curtains are, their origin, statistical properties, and their impact on the atmosphere. Answering these questions is an essential next step towards a more complete understanding of how curtains affect the  magnetosphere and Earth.

Recently developed multi-spacecraft missions, such as AC6, are necessary to distinguish curtains from similar-looking transient precipitation called electron microbursts. Microbursts have been observed since mid 1960s by high altitude balloons and satellites and are also a spiky increase of electrons shorter than a second but are not stationary \cite<e.g.>{Anderson1964, Lorentzen2001a, O'Brien2003, Douma2017}. Two spacecraft are necessary to observe curtains at the same position, and microbursts at the same time. A closely related study by\citeA{Shumko2020} investigates AC6 observations of microbursts.

Curtains and microbursts can be easily misidentified from a single spacecraft so we need to reevaluate single satellite microburst studies. The impact of microbursts on the environment has been shown by \citeA{Douma2019} and \citeA{Breneman2017}, among others, to be substantial. These authors estimated that microbursts can deplete the outer radiation belt electrons in around a day. Furthermore, \citeA{Seppala2018} modeled a 6 hour microburst storm and concluded that microbursts depleted mesospheric ozone by roughly 10\%. If curtains are numerous then the estimated occurrence rates and microburst impact on the atmosphere and the outer radiation belt is overestimated.

To understand the origin of curtains \citeA{Blake2016} proposed the following hypothesis. If a microburst is not completely lost into the atmosphere after the initial scatter, then the remaining microburst electrons will smear out (bounce phase average) along the entire magnetic field line. At the same time these electrons will drift to the east, with faster energy electrons drifting at a faster rate, and the initially localized microburst is smeared in longitude into the shape of a curtain.
