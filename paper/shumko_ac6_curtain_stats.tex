...
\item A few curtains locally precipitated for at least six seconds
\end{keypoints}
...
\item some curtains locally precipitate for an extended period of time. AC6 can't answer this question, but curtains could provide a substantial source of HOx and NOX molecules responsible for destroying ozone. We need AC6 with energy and pitch angle resolution.
\end{enumerate}}
