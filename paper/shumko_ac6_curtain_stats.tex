...
\textcolor{red}{Without pitch angle resolution, we will use AC6's location above Earth to distinguish between drifting and immediately precipitating particles. This is made possible because Earth’s magnetic field is asymmetric which creates a region of weaker magnetic field in the South Atlantic Anomaly (SAA) }
